...
public class PlongeeTest {
    ...
    public void testAjouterParticipant(){
            // on ajoute plongeur a la liste des participants de la plongee
            plongee1.ajouteParticipant(plongeur);
            assertEquals(plongee1.listePlongeurs.get(plongee1.listePlongeurs.size()-1),plongeur);
    }
